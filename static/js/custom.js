...
*************************/
 ...
 if($(".our-skills").length != 0) {
 	 $('.our-skills').appear(function() { 
       $('#bar-9').jqbar({ label: 'css3', barColor: '#1C3554FF', value: 50, orientation: 'v' });
       $('#bar-10').jqbar({ label: 'HTML5', barColor: '#1C3554FF', value: 90, orientation: 'v' });
       $('#bar-11').jqbar({ label: 'Wordpress', barColor: '#1C3554FF', value: 70, orientation: 'v' });
       $('#bar-12').jqbar({ label: 'SEO', barColor: '#1C3554FF', value: 50, orientation: 'v' });
   }, {
  offset: 200
  });
 }
